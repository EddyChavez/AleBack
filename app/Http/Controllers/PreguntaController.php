...
class PreguntaController extends Controller
{
    ...
    {
        //
        $pregunta = Pregunta::where('BORRADO', '0')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $pregunta->FK_SECCION= $request->input('FK_SECCION');
    ...
    public function destroy($pregunta_id)
    {
        ...
        try{
            $pregunta_id;
            $pregunta = Pregunta::where('PK_PREGUNTA', $pregunta_id)->first();
            $respuestas = Respuesta_Posible::where('FK_PREGUNTA', $pregunta_id)->get();
